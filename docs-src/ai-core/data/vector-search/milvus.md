...
- **Mode Configuration**: [`bob-mode/base-mode/milvus.yaml`](https://github.com/ibm-self-serve-assets/building-blocks/tree/main/data-for-ai/vector-search/milvus/bob-mode/base-mode/milvus.yaml)
...
For more information, see the [Bob Mode README](https://github.com/ibm-self-serve-assets/building-blocks/tree/main/data-for-ai/vector-search/milvus/bob-mode/README.md).
